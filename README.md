About r-tmaptools-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-tmaptools-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7076&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-tmaptools-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-tmaptools` can be installed with `conda`:
...
```
mamba install r-tmaptools
```

It is possible to list all of the versions of `r-tmaptools` available on your platform with `conda`:
...
```
mamba search r-tmaptools --channel conda-forge
```
...
mamba repoquery search r-tmaptools --channel conda-forge

# List packages depending on `r-tmaptools`:
mamba repoquery whoneeds r-tmaptools --channel conda-forge

# List dependencies of `r-tmaptools`:
mamba repoquery depends r-tmaptools --channel conda-forge
```
